...
void InitRender()
{
    ...
    for (uint i = 0; i < g_Settings.m_TableSettings.m_Columns.Length; ++i)
    {
        auto @columnSetting = g_Settings.m_TableSettings.m_Columns[i];
        g_TableColumns.InsertLast(@g_AllTableColumns[columnSetting.m_Type]);
    }
